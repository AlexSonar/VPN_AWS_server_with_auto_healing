...
variable "shared_credentials_file" {
  description = "The location of the AWS shared credentials file (e.g. ~alex/.aws/credentials)"
}
...
variable "openvpn_install_script_location" {
  ...
  default     = "https://raw.githubusercontent.com/AlexSonar/VPN_AWS_server_with_auto_healing/master/scripts/openvpn-install.sh"
}
